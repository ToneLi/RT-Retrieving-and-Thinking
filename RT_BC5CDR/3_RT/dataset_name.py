FULL_DATA = {
    ...
    "NCBI": {
        "DiseaseClass": ("DiseaseClass", "the class of Disease, the Disease denote that abnormal condition negatively affecting organisms."),
        "SpecificDisease": ("SpecificDisease", "the specific of Disease, the Disease denote that abnormal condition negatively affecting organisms."),
        "CompositeMention": ("CompositeMention", "CompositeMention"),
        "Modifier": ("Modifier", "A modifier is a code that provides the means by which the reporting physician can indicate that a service or procedure that has been performed has been altered by some specific circumstance but has not changed in its definition or code."),
    },
