...
if __name__ == '__main__':
    ...
    test_mrc_data=read_ner_pre_train_data("data/BCD5/sampled_100_test_BCDR.json","data/BCD5/CDR_1shot_prompt2_gpt4_output1.csv")
    # print(train_mrc_data)
    index_, value_ = compute_simcse_knn(test_mrc_data=test_mrc_data, train_mrc_data=train_mrc_data, knn_num=1)
    # print(index_)
    write_file(dir_="data/BCD5/1shot_test.jsonl", data=index_)